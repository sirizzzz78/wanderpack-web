...
export const TripCard = memo(function TripCard({ trip, items, isPast, onDuplicate, onDelete, onFeedback }: TripCardProps) {
  ...
  return (
    ...
    >
      <div style={{ padding: 'var(--card-px)' }}>
        <div className="flex items-start justify-between">
          ...
          <div className="flex flex-col items-end gap-1.5 ml-3 shrink-0">
            <span
              className={`px-6 py-2 rounded-[20px] text-[11px] font-semibold ${
                isPast
      ...
      {/* Progress bar */}
      <div className="flex items-center gap-2" style={{ padding: '0 var(--card-px) var(--card-px)' }}>
